...
prüfen, welche Variante die beste Antwortqualität liefert. Es werden insgesamt drei LLM-Varianten als Antwortgenerator getestet, darunter zwei OpenAI-Modelle
(\texttt{gpt-4o-mini} und \texttt{gpt-4o}) sowie ein Mistral-Modell
(\texttt{mistral-small-latest}). Neben den einzelnen Komponenten der Pipeline, soll besonders der Vergleich der Modellgrößen untersucht werden, um die Frage zu beantworten, ob ein größeres Modell automatisch bessere Antworten liefert.
% =====================================================================
\section{Vorgehen}
\label{sec:vorgehen}
% =====================================================================
...
statt sie in einer vollen Kombinatorik zu vermischen, da mit jeweils drei bis sieben Varianten eine vollständige Kombinatorik zu aufwändig wäre.
...
GPT-4o-mini und 0,772 für Mistral). Der Vergleich zwischen \texttt{gpt4o-mini} und \texttt{gpt4o} zeigt, dass ein größeres Modell nicht automatisch bessere Antworten liefert -- die Unterschiede sind in der Praxis marginal, aber die Kosten pro Token deutlich höher. 
